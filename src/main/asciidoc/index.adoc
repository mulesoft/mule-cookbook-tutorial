...
* Code related to the connection/configuration is injected into your @ConnectionStrategy annotated field. There are several types of configuration you can use as we will see in this tutorial.
